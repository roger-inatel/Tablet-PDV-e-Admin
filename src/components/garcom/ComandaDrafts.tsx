...
interface ComandaDraftsProps {
  drafts: ItemDraft[];
  /** When false the qty steppers are hidden (read-only / locked comanda). */
  editable: boolean;
...
export function ComandaDrafts({ drafts, editable, onInc, onDec }: ComandaDraftsProps) {
